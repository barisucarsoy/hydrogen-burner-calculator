...
class InputFields:
    def __init__(self, parent):
        self.entries = {}
        self.create_geometry_inputs(parent)
        self.create_operating_inputs(parent)
    ...
    def create_geometry_inputs(self, parent):
        ...
        self.create_input_fields(parent, "Geometric Parameters", params, row_start=0)
    ...
    def create_operating_inputs(self, parent):
        ...
        self.create_input_fields(parent, "Operating Parameters", params, row_start=1)
