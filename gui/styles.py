...
def setup_styles():
    ...
    style.configure('TileValue.TLabel', font=('JetBrains Mono', 14, 'bold'), background='#2E2E2E', foreground='#90EE90')
    style.configure('Tile.TButton', font=('JetBrains Mono', 16, 'bold'), padding=15, background='#404040',
                    foreground='white')
